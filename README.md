...
## Segurança Supabase — v0.6.1

Antes de liberar a beta, execute `supabase/v0.6.1-security-hardening.sql`.
Depois, `supabase/security-check.sql` pode ser executado a qualquer momento para inspecionar RLS/grants sem modificar o banco.
Veja `SECURITY-AUDIT.md` para o relatório completo.
